export function AboutSection() {
  const stats = [
    ...
    { value: "4", label: "курса повышения квалификации" },
    { value: "ФГОС", label: "соответствие стандарту" },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-foreground/60 font-mono text-sm leading-relaxed mb-6">
              Меня зовут Борисова Дарья Игоревна. Я воспитатель дошкольного образовательного учреждения с опытом работы 4 года. Работаю с детьми, создаю безопасную, развивающую и тёплую атмосферу для каждого ребёнка.
            </p>
            <p className="text-foreground/60 font-mono text-sm leading-relaxed">
              Регулярно повышаю квалификацию — изучаю STEAM-образование, ИКТ и инклюзивный подход к детям с ОВЗ. Моя цель — помочь каждому малышу раскрыть свой потенциал и полюбить процесс познания мира.
            </p>
          </div>
